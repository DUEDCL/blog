---
title: duchenlin.eu.cc
description: 这个站本身。Astro 静态站，Markdown 写作，推送即部署，全站不依赖境外 CDN。
pubDate: 2026-08-16
tags: ['Astro', 'Cloudflare Pages']
link: 'https://duchenlin.eu.cc'
...
- **Cloudflare Pages**：推送到 GitHub 自动构建部署，免费额度对个人站远远够用。
